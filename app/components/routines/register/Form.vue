        ...
        <div id="weeks">
          <div class="form-check d-flex flex-wrap w-100">
            <label class="form-label">：<span style="color: var(--bs-red)">日</span>
              <input type="checkbox" @change="weekEvent" v-model="weeks" name="weeks" class="form-check-input shadow-sm" value="sunday">
            </label>
            <label class="form-label">：月<input type="checkbox" @change="weekEvent" v-model="weeks" name="weeks" class="form-check-input shadow-sm"
                                                value="monday"></label>
            <label class="form-label">：火<input type="checkbox" @change="weekEvent" v-model="weeks" name="weeks" class="form-check-input shadow-sm"
                                                value="tuesday"></label>
            <label class="form-label">：水<input type="checkbox" @change="weekEvent" v-model="weeks" name="weeks" class="form-check-input shadow-sm"
                                                value="wednesday"></label>
            <label class="form-label">：木<input type="checkbox" @change="weekEvent" v-model="weeks" name="weeks" class="form-check-input shadow-sm"
                                                value="thursday"></label>
            <label class="form-label">：金<input type="checkbox" @change="weekEvent" v-model="weeks" name="weeks" class="form-check-input shadow-sm"
                                                value="friday"></label>
            <label class="form-label">：<span style="color: var(--bs-blue)">土</span>
              <input type="checkbox" @change="weekEvent" v-model="weeks" name="weeks" class="form-check-input shadow-sm" value="saturday">
            </label>
          </div>
        </div>
