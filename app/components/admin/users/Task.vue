...
import type {AdminTask} from "~/interfaces";
      ...
      <div class="_task_column">
        <div class="_task_row d-flex justify-content-between _text_free">
          ...
          <div class="d-flex _task_right">
            <div class="_task_completed_parent">
              <div v-if="task.completed" class="_task_completed">完了</div>
              <div v-else class="_task_not_completed">未完了</div>
            </div>
            <div class="_task_due_date">
