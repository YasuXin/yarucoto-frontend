...
const deleteEvent = async () => {
  ...
  try {
    const params: { id: number } = {id: selectedDeleteId.value ?? 0}
...
const moveFirstPaginationEvent = (e: Event): void => {
  paginationCurrentNum.value = 1
  setPaginationEvent(paginationCurrentNum.value)
}
const moveLastPaginationEvent = (e: Event): void => {
  ...
  <div id="content" class="d-flex">
    ...
    <main class="py-3 px-0 shadow">
      <div v-show="afterLoad" id="main-child"
        ...
        <div class="my-3">
          <NuxtLink to="/inquiry/form" class="_normal_link my-3">戻る</NuxtLink>
        </div>
        ...
        <transition-group name="list" appear tag="div" id="inquiries">
          <InquiriesInquiry @delete="showDeleteModalEvent" v-for="inquiry in inquiries" :inquiry="inquiry" :key="inquiry.id"></InquiriesInquiry>
        </transition-group>
        <Pagination :isPagination="isPagination"
                    :paginationCurrentNum="paginationCurrentNum"
                    :paginationTotalNum="paginationTotalNum"
