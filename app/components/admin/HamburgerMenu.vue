      ...
      <nav class="navbar py-0 d-flex flex-column" aria-labelledby="dropDown">
        <div class="_hamburger_inner_box">
          <div class="container-fluid _hamburger_link">
            <NuxtLink class="navbar-brand" to="/admin/home">
              <p>ホーム</p>
            </NuxtLink>
          </div>
          <div class="container-fluid _hamburger_link">
            <NuxtLink class="navbar-brand" to="/admin/users/list">
              <p>会員一覧</p>
            </NuxtLink>
          </div>
          <div class="container-fluid _hamburger_link">
            <NuxtLink class="navbar-brand" to="/admin/tasks/list">
              <p>タスク一覧</p>
            </NuxtLink>
          </div>
          <div class="container-fluid _hamburger_link">
            <NuxtLink class="navbar-brand" to="/admin/inquiries/list">
              <p>お問合せ一覧</p>
            </NuxtLink>
          </div>
          <div class="container-fluid _hamburger_link">
            <NuxtLink class="navbar-brand" to="/admin/information/list">
              <p>お知らせ一覧</p>
            </NuxtLink>
          </div>
          <div class="container-fluid _hamburger_link">
